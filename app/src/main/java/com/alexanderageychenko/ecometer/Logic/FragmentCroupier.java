...
public class FragmentCroupier {
    ...
    /**
     * Если стек фрагментов активен - тогда удалит все промежуточные фрагменты между первым и последним, и вызовет у последнего getActivity.onBackPressed()
     * Если стек фрагментов не активен - удалит все фрагменты кроме первого.
     * <p>
